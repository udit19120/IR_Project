...
class DataLoader(object):
    ...
    def __init__(self, filename, batch_size, opt, evaluation):
        ...
        self.source_ma_set, self.source_ma_list, self.source_train_data, self.source_test_data, self.source_user, self.source_item = self.read_data(
            source_train_data, source_test_data)
